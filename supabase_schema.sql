...
-- Disable Row Level Security (RLS) as per user request for functionality
...
-- Drop existing policies if any (to be clean, though disabling RLS makes them inactive)
